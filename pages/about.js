    ...
    <Index title="">
      <div className="p-4 my-20 mx-auto max-w-md w-3/4 rounded-md bg-jlc-sub justify-start">
        ...
        <div className="mt-5 mb-3 mx-full">
          ...
          <div>サイト上の不具合、表示乱れ等のお問い合わせは<a href="https://x.com/Lexio_Japan" className="text-blue" target="_blank">こちら</a>まで</div>
        </div>
        <div className="mt-6">新規登録は<Link href="/register_email" className="text-s text-blue">こちら</Link></div>
        <div className="my-2">ログインは<Link href="/login" className="text-s text-blue">こちら</Link></div>
      </div>
    </Index>
  )
}
